# Fix Attempt1 [PROMPT]
**Timestamp:** 2026-01-14-19-12-44-286
...
- **Requirement:** reqs\02_node-labels.md
- **Test:** tests/failing/02_node-labels.py
...
```bash
C:\Users\Human\Desktop\prjx\json2treeviz\ai-coder\bin\uv.exe run --script ./ai-coder/scripts/test.py tests/failing/02_node-labels.py
```
...
- `tests/failing/02_node-labels.py` -- the test file for this requirement
