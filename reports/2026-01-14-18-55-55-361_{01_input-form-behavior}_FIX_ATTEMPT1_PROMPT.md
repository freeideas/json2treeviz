# Fix Attempt1 [PROMPT]
**Timestamp:** 2026-01-14-18-55-55-361
...
- **Requirement:** reqs\01_input-form-behavior.md
- **Test:** tests/failing/01_input-form-behavior.py
...
```bash
C:\Users\Human\Desktop\prjx\json2treeviz\ai-coder\bin\uv.exe run --script ./ai-coder/scripts/test.py tests/failing/01_input-form-behavior.py
```
...
```bash
C:\Users\Human\Desktop\prjx\json2treeviz\ai-coder\bin\uv.exe run --script ./ai-coder/scripts/track-reqIDs.py $REQ_ID
```
...
```bash
C:\Users\Human\Desktop\prjx\json2treeviz\ai-coder\bin\uv.exe run --script ./ai-coder/scripts/visual-test.py <image_path>... "<assertion>" --test-script <test_file>
```
...
```bash
C:\Users\Human\Desktop\prjx\json2treeviz\ai-coder\bin\uv.exe run --script ./ai-coder/scripts/code-inspection-assertion.py "<assertion>" --code-path ./code
```
...
```bash
C:\Users\Human\Desktop\prjx\json2treeviz\ai-coder\bin\uv.exe run playwright install
```

## What You Can Modify

- `./code/*` -- implementation files
- `tests/failing/01_input-form-behavior.py` -- the test file for this requirement
...
- `./ai-coder/*` - system scripts and prompts
