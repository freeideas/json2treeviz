# Fix Attempt1 [PROMPT]
**Timestamp:** 2026-01-14-18-59-11-971
...
- **Requirement:** reqs\01_json-input.md
- **Test:** tests/failing/01_json-input.py
...
```bash
C:\Users\Human\Desktop\prjx\json2treeviz\ai-coder\bin\uv.exe run --script ./ai-coder/scripts/test.py tests/failing/01_json-input.py
```
...
- `tests/failing/01_json-input.py` -- the test file for this requirement
